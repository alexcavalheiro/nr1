...
export function ensureDb(): Promise<void> {
  g.__dbReady ??= (async () => {
    ...
    for (const extra of ["20260605000000_corporate_data", "20260605010000_role_permissions", "20260605020000_access_security", "20260605030000_employees", "20260605040000_org_plan", "20260605050000_org_theme"]) {
      try {
